	...
	render: function render() {
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				'div',
				{ className: 'text-muted pull-left dp-header--nav-button', onClick: this.handleClickPrevious },
				'«'
			),
			_react2.default.createElement(
				'span',
			...
			_react2.default.createElement(
				'div',
				{ className: 'text-muted pull-right dp-header--nav-button', onClick: this.handleClickNext },
				'»'
			)
		);
	}
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(Calendar, { selectedDate: this.state.selectedDate, displayDate: this.state.displayDate, onChange: this.onChangeDate, dayLabels: this.props.dayLabels }),
